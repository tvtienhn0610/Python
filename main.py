...
prediction_days = 60
# so ngay lay du lieu de so sanh
furure_day = 30 
#so ngay sau 60 ngay de du doan


x_train , y_train = [], []

for x in range(prediction_days , len(scaled_data)-furure_day):
    x_train.append(scaled_data[x-prediction_days:x ,0])
    y_train.append(scaled_data[x + furure_day ,0])
